        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <form class="form-horizontal" role="form" id="societyRecords" method="POST" action="<?php echo site_url('updateUserSave') ?>">
                        	<fieldset>
                        		<div class="col-sm-12">
	                                ...
	                                <div class="form-group">
	                                	<div class="col-sm-4 hidden">
		                                	...
		                                	<input type="text" placeholder="Enter User Name" name='member_id' class="form-control" value="<?php echo $user_details[0]['member_id'] ?>">
		                                </div>
	                                	<div class="col-sm-4">
		                                	<label class="control-label">Name <span class="mandaory">*</span></label>
		                                	<input type="text" placeholder="Enter User Name" name='member_name' class="form-control" value="<?php echo $user_details[0]['member_name'] ?>">
		                                </div>
	                                	<div class="col-sm-4">
	                                		<label class="control-label">Email <span class="mandaory">*</span></label>
	                                		<input type="email" placeholder="Enter User Email ID" name="member_email" class="form-control" value="<?php echo $user_details[0]['member_email'] ?>">
	                                	</div>
	                                	<div class="col-sm-4">
	                                		<label class="control-label">Contact <span class="mandaory">*</span></label>
	                                		<input type="text" placeholder="Enter User Contact No." name="member_mobile" class="form-control" value="<?php echo $user_details[0]['member_mobile'] ?>">
	                                	</div>
	                                </div>
	                                <div class="form-group">
	                                	<!-- <div class="col-sm-4">
	                                	...
	                                	<div class="col-sm-4">
	                                		...
	                                		<input type="password" placeholder="Re Enter Password" name="member_re_password" class="form-control">
	                                	</div>
	                                	<div class="col-sm-4">
		                                	...
		                                	<select class="form-control" name="member_role_id">
		                                		...
		                                		<?php foreach ($user_role as $key) { ?>
		                                			<?php if($key['id'] ==  $user_details[0]['member_role_id']){ ?>
		                                			<option value="<?php echo $key['id'] ?>" selected><?php echo $key['role'] ?></option>
		                                			<?php }else{ ?>
	                                ...
	                                <div class="form-group">
	                                 	<div class="col-sm-4">
		                                	...
		                                	<?php foreach ($all_com as $key) {?>
		                                		<?php if($key['com_id'] ==  $user_details[0]['member_com_id']){ ?>
		                                		<option value="<?php echo $key['com_id'] ?>" selected><?php echo $key['com_name'] ?></option>
		                                	<?php }else{ ?>
