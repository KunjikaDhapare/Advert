...
<body class="" style="overflow-y: hidden;padding-right: 10%;">
    ...
    <center><a href="<?php echo site_url('/') ?>"><img src="<?php echo $logo ?>" width="50%"></a></center>
        <div>
            <form method="post" class="m-t" role="form" action="<?php echo site_url('updatePassword')?>">
                ...
                <div class="form-group col-sm-12" style="float:right;">
                    <!-- <u><a href="<?php echo site_url('Welcome/forgot_password')?>"><small>Forgot password ?</small></a></u> -->
                </div>
                <div class="form-group col-sm-12">
                    <center><button type="submit" class="btn btn-primary block m-b"><i class="fa fa-user fa-lg"> Update</i></button></center>
                </div>
            </form><br>
                <!-- <p class="text-muted text-center"><small>Do not have an account?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="<?php echo site_url('Welcome/registration_detials')?>">Create an account</a> -->
