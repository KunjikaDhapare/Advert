            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a href="<?php echo site_url('newSize')?>"><span class="btn btn-success"><i class="fa fa-plus"></i> Add</span></a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody id="myTable">
                            	...
                            	<?php }else{ $i = 1; foreach ($all_size as $key) {?>
                                    <tr>
		                                <td><?php echo $i++; ?></td>
		                                <td><?php echo $key['size_name']?></td>
		                                <td><?php if($key['size_isDelete'] == 0){ echo "Activated";}else{ echo "Not Activated";}?></td>                                      
		                            </tr>
		                        <?php } }?>
                            </tbody>
                        </table>
