...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
    	<form class="form-horizontal" role="form" id="ownerRecords" method="POST" action="<?php echo site_url('ownerShopDetails') ?>">
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <?php if(!empty($shop_details)){ ?>
	                    <div class="ibox-tools">
	                        ...
	                        <a href="<?php echo site_url('owner')?>"><span class="btn btn-primary"><i class="fa fa-building"></i> Flat Owner</span></a>
	                    </div>
                	<?php } ?>
                </div>
	                        ...
	                        <div class="panel-heading">
	                            <div class="panel-options">
	                                <ul class="nav nav-tabs">
	                                    <li class="active"><a data-toggle="tab" href="#tab-1">Shop Owner Details</a></li>
	                                </ul>
	                            </div>
	                        </div>
									                        ...
									                        <table class="table table-striped">
									                            <thead>
										                            <tr>
										                                ...
										                                <!-- <th class="hidden"><center>Shop No</center></th> -->
									                            ...
									                            <tbody>
								                        			<?php $shop_details = $CI->Home_model->fetch_details(array('wing_name' => $key['wing_name'],'wing_soc_id'=>$key['wing_soc_id'],'wing_category'=>2 ),'rs_wing');

								                        			if(empty($shop_details)){ ?>
									                                    <td colspan="9"><h3 class="no-records">No Records Found.</h3></td>
									                            	<?php }else{ $i = 1;foreach ($shop_details as $key) {?>
									                            		<?php $member_details = $CI->Home_model->fetch_details('member_shop_wing_id='.$key['wing_id'].' AND member_soc_id='.$key['wing_soc_id'].' AND	member_is_deactive=0 AND member_owner_type IN(2,4,5)','rs_member'); ?>
								                        					<tr>
								                        						...
								                        						<td class="hidden"><center>
								                        							<input type="text" class="form-control" name="member_soc_id[<?php echo $j ?>]" placeholder="Enter Owner Name" value="<?php echo $key['wing_soc_id'] ?>">
								                        						</center></td>
								                        						<td class="hidden"><center>
								                        							<input type="text" class="form-control" name="member_wing_id[<?php echo $j ?>]" placeholder="Enter Owner Name" value="<?php echo $key['wing_id'] ?>">
								                        						</center></td>
								                        						<!-- <td class="hidden"><center>
								                        						...
								                        						<td><center><?php echo $key['wing_floors'] ?></center></td>
								                        						<td><center>
								                        							<input type="text" class="form-control" name="shop_number[<?php echo $j ?>]" placeholder="Enter Owner Name" value="<?php echo $key['wing_shop_no']; ?>"></center>
								                        						</td>
								                        						<td>
